  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @can('language.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('language.create') !!}"><i class="fa fa-plus mr-2"></i>Languages Category</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>Edit Languages</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
