  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        @can('country.index')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('balance.index') !!}"><i class="fa fa-list mr-2"></i>Balance list</a>
        </li>
        @endcan
        @can('country.create')
        <li class="nav-item">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>Add Balance</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
