...
@can('galleries.approval')
<!-- Approved Field -->
    @if(isset($gallery))
  <div class="form-group row ">
    <label for="approved" class="col-3 control-label text-right">Approved</label>
    <div class="col-9">
      <select class="form-control" placeholder="Insert Rate" name="approved" id="approved">
