    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Edit Banned Users</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('bannedUsers.create') !!}"><i class="fa fa-plus mr-2"></i>Add Banned Users</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>Edit Banned Users</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      {!! Form::model($bannedUsers, ['route' => ['bannedUsers.update', $bannedUsers->id], 'method' => 'PUT']) !!}
      <div class="row">
