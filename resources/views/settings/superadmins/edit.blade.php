  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{!! route('superAdminsBoard.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.super_admins_list')}}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{!! route('superAdminsBoard.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.super_admins_create')}}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.super_admins_edit')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body" data-route="{{url('api/user/select')}}">
      {!! Form::model($user, ['route' => ['superAdminsBoard.update', $user->id],'enctype'=>"multipart/form-data" , 'method' => 'patch']) !!}
      <div class="row">
