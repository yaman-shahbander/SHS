    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <li class="nav-item">
                        <a class="nav-link active" href="{!! route('vendor.fee') !!}"><i class="fa fa-plus mr-2"></i>Featured Fee</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
        {!! Form::open(['route' => 'fee.save']) !!}
          <div class="form-group col-md-6 row">
              {!! Form::label('fee_amount', 'Fee Amount', ['class' => 'col-md-3 control-label']) !!}
              <div class="col-md-9">
              ...
              <div class="form-group col-12 text-right" style="left:528px; top:35px">
                    <button type="submit" class="btn btn-{{setting('theme_color')}}"><i class="fa fa-save"></i> Save Fee</button>
