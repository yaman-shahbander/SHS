  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{!! route('adminsBoard.index') !!}"><i class="fa fa-list mr-2"></i>{{ trans('lang.admins_list') }}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{ trans('lang.admins_create') }}</a>
        </li>
      </ul>
    </div>
    <div class="card-body" data-route="{{url('api/user/select')}}">
      {!! Form::open(['route' => 'adminsBoard.store','files' => true, 'enctype'=>"multipart/form-data", 'method' => 'post']) !!}
      <div class="row">
