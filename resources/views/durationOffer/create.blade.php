  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('durationOffer.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.duration_offers_table')}}</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.duration_offers_create')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      {!! Form::open(['route' => 'durationOffer.store']) !!}
      <div class="row">
        @include('durationOffer.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
