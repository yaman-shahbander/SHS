...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{__('lang.special_offers')}}<small class="ml-3 mr-3">|</small><small>{{ trans('lang.create_special_offers') }}</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{ trans('lang.edit_special_offers') }}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        @can('offers.index')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('offers.index') !!}"><i class="fa fa-list mr-2"></i>{{__('lang.special_offers')}}</a>
        </li>
        @endcan
        @can('offers.create')
        <li class="nav-item">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{ trans('lang.edit_special_offers') }}</a>
        </li>
      </ul>
    </div>
