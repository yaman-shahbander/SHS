    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Sub Categories Vendor</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{!! route('subcategory.index') !!}"><i class="fa fa-list mr-2"></i>Sub Categories List</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{!! route('subcategory.create') !!}"><i class="fa fa-plus mr-2"></i>Create Sub Category</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>Sub Category Vendor</a>
        </li>
