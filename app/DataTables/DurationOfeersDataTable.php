<?php
/**
 * File name: durationDataTable.php
...
class DurationOfeersDataTable extends DataTable
{
    /**
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(Duration::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', Duration::class)->where('in_table', '=', true)->get();
