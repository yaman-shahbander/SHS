<?php
/**
 * File name: PendingReviewDataTable.php
...
class PendingReviewDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'pending_reviews.datatables_actions')
    ...
    protected function getColumns()
    {
        ...
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', reviews::class)->where('in_table', '=', true)->get();
