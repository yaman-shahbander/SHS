...
class CityDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('country_id', function ($city) {
                return getCItyRelationName($city);
            })
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(city::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', city::class)->where('in_table', '=', true)->get();
