...
class FavoriteVendorDataTable extends DataTable
{
    ...
    {$request=$this->id;
          return $model->newQuery()->whereHas('homeOwnerFavorite',function($query) use ($request){
                    $query->where('favorite_user.user_id',$request);
          });
    }
